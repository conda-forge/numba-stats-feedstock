...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/numba-stats-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11793&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/numba-stats-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `numba-stats` can be installed with:

```
conda install numba-stats
```

It is possible to list all of the versions of `numba-stats` available on your platform with:
